...
const steps = [
  {
    number: '01',
    title: 'Strategize',
    description: 'Define goals, audience, structure, and conversion priorities.',
  },
  {
    number: '02',
    title: 'Design',
    description: 'Create a clear, modern experience built around your customers.',
  },
  {
    number: '03',
    title: 'Build',
  ...
  },
  {
    number: '04',
    title: 'Grow',
    description: 'Launch, measure performance, and improve what works.',
  },
]
      ...
      <div className="container">
        <div className="mb-10 text-center md:mb-20">
          <RevealWrapper className="reveal-me mb-3 flex justify-center">
            <SectionLabel>Your Website Journey</SectionLabel>
          </RevealWrapper>
          <RevealWrapper className="reveal-me">
            <h2 className="text-center max-md:text-3xl md:text-6xl md:leading-[1.2] md:tracking-[-1.68px]">
              From strategy to <InstrumentText>growth.</InstrumentText>
            </h2>
          </RevealWrapper>
        </div>
