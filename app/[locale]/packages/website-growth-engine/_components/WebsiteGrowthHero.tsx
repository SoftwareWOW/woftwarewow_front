...
const HERO_IMAGES = [
  ...
  '/images/wow/nav/cards/Websit%20groeh%201.png',
  '/images/wow/nav/cards/Host.png',
...
const WebsiteGrowthHero = ({
  ...
  const image0 = images?.[0] ?? { src: '/images/wow/nav/cards/Website%20Growth%201.png', alt: 'Website growth' }
  const image1 = images?.[1] ?? { src: '/images/wow/nav/cards/Website%20Growth%202.png', alt: 'High performance website' }
