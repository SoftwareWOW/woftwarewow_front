...
const foundations = [
  ...
  { title: 'Social', description: 'Launch-ready social presence' },
  { title: 'Technology', description: 'Essential tools and systems' },
  { title: 'Hosting', description: 'Reliable digital infrastructure' },
]
...
export default LaunchFoundations
