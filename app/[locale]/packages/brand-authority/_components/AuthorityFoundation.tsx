...
const foundations = [
  ...
  {
    title: 'Identity',
    description: 'Create a consistent and recognizable brand presence.',
  },
  {
    title: 'Thought Leadership',
    description: 'Turn your expertise into valuable content and ideas.',
  },
  {
    title: 'Digital Presence',
    description: 'Build credibility across your website and key channels.',
  },
  {
    title: 'Reputation',
    description: 'Strengthen trust and how your brand is perceived.',
  },
]
        ...
        {foundations.map((item) => (
          ...
          >
            <Link href="/contact" className="block">
              ...
              <p className="mb-20 text-base leading-relaxed text-[#808080] lg:mb-[106px]">{item.description}</p>
              <ArrowButton />
            </Link>
          </RevealWrapper>
        ))}
...
export default AuthorityFoundation
