...
const DEFAULT_IMAGE = '/images/wow/nav/cards/Softwaerwow.png'
...
const ProductJourney = ({
  ...
  title = 'Clear steps from concept to launch.',
  description = 'Growth works better when the product is built in clear stages — from discovery through launch.',
  steps,
  image,
}: Props = {}) => {
