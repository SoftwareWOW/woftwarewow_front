...
const points = [
  {
    id: '01',
    title: 'Intuitive UX',
    description: 'Simple experiences designed for mobile interactions.',
  },
  {
    id: '02',
    title: 'Performance',
    description: 'Fast, responsive experiences across supported devices.',
  },
  {
    id: '03',
    title: 'Connected Systems',
    description: 'Integrate APIs, platforms, and business systems.',
  },
  {
    id: '04',
    title: 'Secure by Design',
    description: 'Security considered throughout development.',
  },
  {
    id: '05',
    title: 'Ready to Scale',
    description: 'Built to evolve as users and requirements grow.',
  },
]

/** Layout: packages/saas-product-development/FocusFirstRelease (Home-19 ElevateBrandV2) */
const BuiltForMobile = () => {
  return (
    <section>
      <div className="container">
        <RevealWrapper className="reveal-me mb-5">
          <SectionLabel>Built for Mobile</SectionLabel>
        </RevealWrapper>
          ...
          <div className="flex-1">
            <TextAppearAnimation02>
              <h2 className="text-appear-2">
                Designed for the way people actually use <InstrumentText>mobile.</InstrumentText>
              </h2>
            </TextAppearAnimation02>
          </div>
          <div className="w-full md:w-80 lg:w-96">
            <TextAppearAnimation>
              <p className="text-appear text-appear-2 max-w-lg max-md:text-justify md:place-self-end md:text-right">
                Your app is shaped around real mobile habits—not desktop patterns squeezed onto a smaller screen.
              </p>
            </TextAppearAnimation>
          </div>
        </div>
