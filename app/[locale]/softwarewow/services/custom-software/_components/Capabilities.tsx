...
const FlipCard = ({ item }: { item: Capability }) => (
  <RevealWrapper className="group relative min-h-[410px] w-full overflow-hidden rounded-radius-sm md:w-[calc(50%-10px)] lg:w-[calc(33.333%-14px)] xl:w-[390px]">
    <div>
