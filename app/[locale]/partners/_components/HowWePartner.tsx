      ...
      <div className="container">
        ...
        <RevealWrapper className="grid grid-cols-12 items-center justify-center gap-[1px]">
          {partnershipTypes.map((type) => (
            ...
            >
              <h4 className="pb-3 leading-[1.2] transition-colors duration-300 group-hover:text-white md:mb-4">
                {type.title}
              </h4>
              <p className="text-[17px] italic leading-[25.5px] text-[#000000b3] transition-colors duration-300 group-hover:text-white dark:text-dark-100">
                {type.description}
              </p>
            </div>
          ))}
