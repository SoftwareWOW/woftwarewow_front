...
const packages = [
  {
    ...
    description: 'Turn your storefront into a stronger growth channel.',
    href: '/packages/website-growth-engine',
  },
  {
    number: '02',
    title: 'Sales Acceleration',
    description: 'Build smarter funnels, CRM systems, customer journeys, follow-up, and conversion systems.',
    href: '/packages/sales-acceleration',
  },
  {
    number: '03',
    title: 'AI Automation',
    description: 'Automate repetitive commerce operations, customer communication, data workflows, and internal processes.',
