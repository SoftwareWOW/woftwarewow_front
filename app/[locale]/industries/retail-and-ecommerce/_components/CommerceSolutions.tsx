...
const solutions: { title: string; description: string; items: string[]; icon: ReactNode }[] = [
  {
    title: 'eCommerce & Digital Experiences',
    description: 'Build fast, intuitive shopping experiences designed around your products and customers.',
    items: ['eCommerce websites', 'UX & UI design', 'Payment integrations', 'Mobile experiences'],
    icon: <IconBars />,
  },
  {
    title: 'Marketing & Customer Acquisition',
    description: 'Reach people across the channels that influence discovery and purchasing decisions.',
    items: ['SEO', 'Paid advertising', 'Content marketing', 'Social campaigns'],
    icon: <IconBolt />,
  },
  {
    title: 'Conversion & Retention',
    description: 'Improve the journey between first visit, purchase, repeat purchase, and customer loyalty.',
    items: ['Conversion optimization', 'Email marketing', 'Remarketing', 'Customer journeys'],
    icon: <IconChart />,
  },
  {
    title: 'Commerce Automation & Technology',
    description: 'Connect the systems behind your business and reduce manual work as order volumes grow.',
    items: ['CRM automation', 'Inventory integrations', 'AI workflows', 'Custom software & integrations'],
    icon: <IconPeople />,
  },
]

/** Layout: Home-23 WhyChooseUsV7 — 2-column bordered icon cards + origin SVGs + bottom CTA. */
const CommerceSolutions = () => {
  return (
    <section>
      <div className="container">
        <div className="mx-auto mb-10 max-w-3xl text-center md:mb-16">
          <RevealWrapper className="reveal-me mb-3 flex justify-center">
            <SectionLabel>Commerce Solutions</SectionLabel>
          </RevealWrapper>
          <TextAppearAnimation>
            <h2 className="text-appear lg:leading-[1.1]">
              Built Around the Way <InstrumentText>People</InstrumentText> Shop.
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear mt-4 text-[#808080]">
              Connect your storefront, marketing, customer experience, and operations into one stronger commerce
              system.
            </p>
          </TextAppearAnimation>
        </div>
          ...
          {solutions.map((item) => (
            ...
            >
              ...
              <ul className="mt-5 space-y-2">
                {item.items.map((line) => (
                  <li key={line} className="text-base leading-[25.6px] text-[#808080]">
                    {line}
                  </li>
                ))}
              </ul>
...
export default CommerceSolutions
