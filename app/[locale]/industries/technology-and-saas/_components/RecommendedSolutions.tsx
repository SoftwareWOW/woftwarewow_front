...
const packages = [
  {
    ...
    description:
      'Bring strategy, UX, development, integrations, and scalable technology together to create a market-ready SaaS product.',
    href: '/packages/saas-product-development',
  },
  {
    number: '02',
    title: 'AI Automation',
    description:
      'Add smarter automation to customer experiences, internal operations, workflows, and product ecosystems.',
    href: '/packages/ai-automation',
  },
  {
    number: '03',
    title: 'Sales Acceleration',
    description: 'Build stronger acquisition, CRM, conversion, and revenue systems around your product.',
          ...
          <div className="w-full md:w-80 lg:w-96">
            <TextAppearAnimation>
              <p className="text-appear text-appear-2 max-w-lg text-[#808080] max-md:text-justify md:place-self-end md:text-right">
                Explore connected packages for building, launching, and scaling technology businesses.
              </p>
            </TextAppearAnimation>
            <RevealWrapper className="reveal-me mt-5 justify-self-end max-md:w-full md:mt-10">
              <ButtonComponentList className="flex justify-end max-md:justify-center" itemClassName="block">
                <ButtonComponent href="/packages/saas-product-development" variant="primary">
