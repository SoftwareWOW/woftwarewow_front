...
const solutions: { title: string; description: string; items: string[]; icon: ReactNode }[] = [
  {
    ...
    description: 'Clarify your offer, audience, brand direction, digital strategy, and path to market.',
    items: ['Brand strategy', 'Business positioning', 'Digital strategy', 'Launch planning'],
    icon: <IconBars />,
  },
  {
    title: 'Brand & Digital Presence',
    description: 'Create the identity and digital foundation your startup needs to look credible from day one.',
    items: ['Brand identity', 'Website design', 'Web development', 'Creative assets'],
    icon: <IconBolt />,
  },
  {
    title: 'Product & Technology',
    description: 'Turn ideas into functional digital products and scalable technology.',
    items: ['MVP development', 'Web applications', 'Mobile applications', 'SaaS platforms'],
    icon: <IconChart />,
  },
  {
    title: 'Launch & Growth',
    description: 'Build the systems that attract customers, generate leads, and help your startup grow after launch.',
    items: ['Digital marketing', 'SEO & content', 'Social media', 'Sales funnels & automation'],
    icon: <IconPeople />,
  },
]
