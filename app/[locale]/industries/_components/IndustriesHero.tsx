          ...
          <div className="w-full max-w-[640px] text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col items-center gap-4 lg:items-start">
              ...
              <div className="flex [&>*:not(:first-child)]:-ml-4">
                <Image src="/images/home-5/review-1.png" alt="User" width={52} height={52} className="size-[52px]" />
                <Image src="/images/home-5/review-2.png" alt="User" width={52} height={52} className="size-[52px]" />
                <Image src="/images/home-5/review-3.png" alt="User" width={52} height={52} className="size-[52px]" />
                <Link
                  href="/contact"
              ...
              <p className="text-base leading-[1.2] text-[#0D0D0D] dark:text-[#F2F2F2]">
                <span className="text-primary">Trusted by 18k+</span>
                <br />
