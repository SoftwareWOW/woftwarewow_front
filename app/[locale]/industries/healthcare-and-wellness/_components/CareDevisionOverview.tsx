...
const DEFAULT_DIVISIONS = [
  {
    ...
    description: 'Modern, accessible websites built around trust and usability.',
  ...
  },
  {
    ...
    description: 'SEO, content, advertising, and audience acquisition.',
  ...
  },
  {
    ...
    description: 'Professional identities and communication materials.',
  ...
  },
  {
    id: 4,
    title: 'AI & Automation',
    description: 'Smarter workflows, assistants, automation, and business insights.',
  ...
  },
  {
    ...
    description: 'Custom platforms, integrations, apps, dashboards, and internal systems.',
  ...
  },
  {
    ...
    description: 'Reliable hosting, domains, email, and digital infrastructure.',
    bgImage: `${DIVISION_BG_BASE}/Server.jpg`,
    href: '/wowhost',
  },
]

/** Layout: homepage DevisionOverview — horizontal-scroll capability cards. */
type CareDevisionOverviewProps = Partial<CmsTechnologiesSection>

const CareDevisionOverview = ({
  eyebrow = 'Divisions Overview',
  title = '',
  accentTitle = '',
  description,
  items,
}: CareDevisionOverviewProps = {}) => {
  ...
  return (
    <section className="relative w-full max-w-full overflow-x-clip">
      <div
        ...
        aria-labelledby="care-divisions-heading"
      >
        <div
          aria-hidden
          ...
          <div className="mx-auto flex w-full max-w-[1320px] items-start justify-between gap-6">
            <div className="max-w-3xl">
              ...
              <TextAppearAnimation>
                ...
                >
                  One Partner for the <span className="font-instrument italic">Bigger Picture.</span>
                </h2>
              </TextAppearAnimation>
              <p
                className={`mt-4 max-w-xl text-base leading-relaxed transition-colors duration-500 ${
                  activeBgId !== null ? 'text-white/80' : 'text-[#808080]'
                }`}
              >
                Your needs can extend far beyond one website or campaign. The WOW ecosystem brings together the
                capabilities required to support your organization.
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          aria-label="Capabilities supporting healthcare and wellness organizations"
              ...
              >
                <article
                  ...
                  className={`relative flex min-h-[260px] flex-col overflow-hidden rounded-radius-sm p-6 transition-colors duration-500 sm:min-h-[280px] sm:p-7 md:min-h-[300px] md:p-8 lg:min-h-[320px] lg:p-9 xl:min-h-[340px] ${
                    isActive ? 'bg-white dark:bg-[#121212]' : 'bg-white/80 dark:bg-[#121212]/90'
                  }`}
                >
...
export default CareDevisionOverview
