...
const solutions: { title: string; description: string; items: string[]; icon: ReactNode }[] = [
  {
    ...
    description: 'Build a credible, professional identity that reflects the quality of your services.',
    items: ['Brand strategy', 'Visual identity', 'Website design', 'Content structure'],
    icon: <IconBars />,
  },
  {
    title: 'Websites & Client Experience',
    description: 'Create intuitive digital experiences that make services, information, and next steps easier to access.',
    items: ['Healthcare websites', 'UX/UI design', 'Booking integrations', 'Mobile experiences'],
    icon: <IconBolt />,
  },
  {
    title: 'Marketing & Visibility',
    description: 'Reach more of the people actively searching for the services you provide.',
    items: ['SEO', 'Content marketing', 'Paid campaigns', 'Social media'],
    icon: <IconChart />,
  },
  {
    title: 'Automation & Business Systems',
    description: 'Simplify repetitive processes and create more connected workflows behind the scenes.',
    items: ['CRM systems', 'Workflow automation', 'AI assistants', 'Custom integrations'],
    icon: <IconPeople />,
  },
]

/** Layout: Home-23 WhyChooseUsV7 / CommerceSolutions — 2-column bordered icon cards + bottom CTA. */
type CareSolutionsProps = Partial<CmsTechnologiesSection>

const CareSolutions = ({
  eyebrow = 'Industry Solutions',
  title = 'Digital Solutions Built Around Care.',
  accentTitle = '',
  description,
  items,
}: CareSolutionsProps = {}) => {
    ...
    <section id="solutions">
      <div className="container">
        <div className="mx-auto mb-10 max-w-3xl text-center md:mb-16">
          ...
          <TextAppearAnimation>
            <h2 className="text-appear lg:leading-[1.1]">{header.title}</h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear mt-4 text-[#808080]">
              Bring your brand, digital experience, marketing, and operational systems together around a better client
              journey.
            </p>
          </TextAppearAnimation>
        </div>
