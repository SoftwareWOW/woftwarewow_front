...
const teams: {
...
}[] = [
  {
    ...
    description: 'Accessible websites for programs, resources, campaigns, and communities.',
  },
  {
    id: '02',
    title: (
    ...
    heading: 'Awareness & Outreach',
    description: 'SEO, campaigns, content, email, and audience growth.',
  },
  {
    id: '03',
    title: (
    ...
    description: 'Social strategy, content creation, community building, and storytelling.',
  },
  {
    id: '04',
    title: (
    ...
    heading: 'Brand & Communication',
    description: 'Identity, campaigns, reports, presentations, and communication materials.',
  },
  {
    id: '05',
    title: (
    ...
    description: 'Simplify communication, repetitive tasks, workflows, and internal processes.',
  },
  {
    id: '06',
    title: (
    ...
    description: 'Portals, platforms, applications, integrations, and internal tools.',
  },
]
