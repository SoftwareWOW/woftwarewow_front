...
const packages = [
  {
    ...
    description:
      'Strengthen your positioning, identity, messaging, and digital presence so your organization communicates with greater clarity and credibility.',
  ...
  },
  {
    ...
    description:
      'Build a stronger digital hub for programs, campaigns, resources, donations, registrations, and engagement.',
  ...
  },
  {
    ...
    title: 'AI Automation',
    description:
      'Reduce repetitive administrative work and create smarter workflows for communication, data, and internal operations.',
        ...
        <div className="mb-16 flex flex-col items-start justify-center gap-x-10 gap-y-3 md:mb-20 md:flex-row md:items-center lg:justify-start">
          <div className="flex-1">
            <TextAppearAnimation02>
              <h2 className="text-appear-2">Built to Strengthen Your Mission.</h2>
            </TextAppearAnimation02>
          </div>
          <div className="w-full md:w-80 lg:w-96">
            <TextAppearAnimation>
              <p className="text-appear text-appear-2 max-w-lg text-[#808080] max-md:text-justify md:place-self-end md:text-right">
                Explore packages that can strengthen your visibility, credibility, digital experience, and
            ...
            <RevealWrapper className="reveal-me mt-5 justify-self-end max-md:w-full md:mt-10">
              <ButtonComponentList className="flex justify-end max-md:justify-center" itemClassName="block">
                <ButtonComponent href="/packages/brand-authority" variant="primary">
