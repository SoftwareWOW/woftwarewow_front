...
type BrandVisualStyleProps = Partial<CmsTechnologiesSection>
...
const BrandVisualStyle = ({
  ...
  items,
  image,
}: BrandVisualStyleProps = {}) => {
  const header = mergeSectionHeader({ eyebrow, title, accentTitle, description }, { eyebrow, title, accentTitle, description })
  const mergedItems = DEFAULT_STEPS.map((item, index) => {
