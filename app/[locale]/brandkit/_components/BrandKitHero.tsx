...
const BrandKitHero = ({
  ...
  title,
  description = 'Access official logos, colors, typography, and brand resources for approved WOW Superagency communications.',
}: BrandKitHeroProps) => (
    ...
    <div className="container">
      <RevealWrapper className="flex flex-col items-center text-center">
        ...
        <h1 id="brandkit-hero-heading" className="mb-4 mt-3.5">
          {title ?? (
            <>
              The <WowText>WOW</WowText> Brand, Ready to Use.
            </>
          )}
        </h1>
