...
const StartupPackage = () => {
  return (
    <section className="relative overflow-hidden" aria-labelledby="startup-package-heading">
      <div className="pointer-events-none absolute right-0 top-0 -z-10 blur-[80px] lg:-right-[10%]">
        <img
          src="/images/hero-gradient-background.png"
          alt=""
          aria-hidden
          className="scale-50 opacity-70"
        />
      </div>

      <div className="mx-auto flex max-w-[1600px] flex-col items-center justify-between gap-x-10 gap-y-12 px-4 md:px-[30px] lg:flex-row">
        <div className="w-full md:flex-1">
          ...
          <RevealWrapper className="reveal-me mt-4">
            <p className="max-w-xl text-base leading-relaxed text-[#808080] md:text-lg">
              Our Startup Launch Package brings together the core foundations needed to take a new business from idea to
              a professional market presence.
            </p>
          </RevealWrapper>
