...
const SIDE_IMAGE = '/images/wow/nav/cards/Intelligent.png'
...
const DigitalFoundations = ({
  ...
  description = "The things customers don't see are often the things keeping everything running.",
  items,
  image,
}: Partial<CmsTechnologiesSection> = {}) => {
  const displayFoundations = mergeFeatureItems(DEFAULT_FOUNDATIONS, items)
