...
/** Layout: Home-16 ServicesV14 — 3 bordered cards; static arrow (no hover button swap). */
        ...
        {stages.map((stage) => (
          ...
          >
            <Link href={stage.href} className="block">
              ...
              <div className="flex size-16 items-center justify-center border dark:border-dark lg:h-24 lg:w-[92px]">
