      ...
      <div className="container">
        ...
        <RevealWrapper className="reveal-me grid grid-cols-12 items-stretch justify-center gap-[1px]">
          {divisions.map((item) => (
            <div
              key={item.title}
              className="group col-span-full min-h-[280px] bg-backgroundBody px-7 pb-4 pt-7 backdrop-blur transition-all duration-300 ease-in-out hover:bg-primary dark:bg-dark dark:hover:bg-primary max-sm:border-x max-sm:border-t max-sm:border-dark/5 sm:col-span-6 md:min-h-[320px] md:px-10 md:pb-12 md:pt-10 lg:col-span-4 xl:col-span-3"
            >
          ...
          <div className="col-span-full flex min-h-[280px] items-center justify-center border border-primary/30 bg-primary/10 px-7 py-10 text-center dark:border-primary/40 dark:bg-primary/15 sm:col-span-6 md:min-h-[320px] lg:col-span-4 xl:col-span-3">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-[#808080]">Centered on</p>
              <h4 className="mt-2 leading-[1.2]">
                WOW <InstrumentText>Superagency</InstrumentText>
              </h4>
            </div>
          </div>
        </RevealWrapper>
