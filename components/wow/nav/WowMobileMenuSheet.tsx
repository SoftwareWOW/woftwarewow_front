...
export default function WowMobileMenuSheet({ item, navbar, onClose }: WowMobileMenuSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1001] xl:hidden">
      ...
      <div className="absolute inset-x-[15px] bottom-[calc(86px+env(safe-area-inset-bottom))] mx-auto flex w-full max-w-[410px] animate-mobile-sheet-in flex-col overflow-hidden rounded-[5px] bg-white p-[10px] shadow-nav dark:bg-dark-200 dark:shadow-none sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2">
        <div className="max-h-[min(461px,calc(100vh-180px))] flex flex-col overflow-hidden">
          ...
          <div className="mt-[10px] flex-1 overflow-y-auto overscroll-contain">
