...
export const navPillInactiveClass =
  'text-black/50 dark:text-dark-100 hover:bg-primary-50 hover:text-black dark:hover:bg-black dark:hover:text-black'
