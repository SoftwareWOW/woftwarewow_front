...
export default function WowButton({ href, children, variant = 'primary', className = '', onClick }: WowButtonProps) {
  const classes = `inline-flex items-center justify-center gap-2 rounded-radius-sm px-6 py-4 text-sm font-semibold tracking-wide transition ${variantClasses[variant]} ${className}`
