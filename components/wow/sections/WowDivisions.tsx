...
const DivisionCard = ({
  ...
  <motion.div
    ...
    <motion.div
      className="relative w-60 overflow-hidden rounded-radius-sm"
    ...
    <section
      ...
      <div
        ...
        <motion.div
          ...
          <motion.div
            className="relative rounded-radius-sm border border-purple-500/30 p-8 backdrop-blur-2xl sm:p-12 md:p-16"
            style={{
