...
import useScrollingSoftwareServices, {
  SCROLLING_SERVICE_CARDS_OPTIONS,
} from '@/hooks/useScrollingSoftwareServices'
import { ChevronLeft, ChevronRight } from 'lucide-react'
import Link from 'next/link'

export type ScrollingServiceCardItem = {
  slug: string
  title: string
  description: string
  feature: string[]
...
type ScrollingServiceCardsMarqueeProps = {
  items: ScrollingServiceCardItem[]
  getItemHref?: (item: ScrollingServiceCardItem) => string
  prevAriaLabel?: string
  nextAriaLabel?: string
}

const ScrollingServiceCardsMarquee = ({
  items,
  getItemHref = () => '/contact',
  prevAriaLabel = 'Previous item',
  nextAriaLabel = 'Next item',
}: ScrollingServiceCardsMarqueeProps) => {
  const { marqueeRef, pauseMarquee, resumeMarquee, goPrev, goNext } =
    useScrollingSoftwareServices(SCROLLING_SERVICE_CARDS_OPTIONS)
...
export default ScrollingServiceCardsMarquee
