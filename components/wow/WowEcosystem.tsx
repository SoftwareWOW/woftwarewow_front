...
const NODE_LAYOUT: NodeLayout[] = [
  ...
  { id: 'hub', x: 58, y: 14, size: 'md' },
  { id: 'impact', x: 82, y: 17, size: 'md' },
  { id: 'design', x: 20, y: 30, size: 'md' },
  { id: 'events', x: 5, y: 16, size: 'md' },
  ...
  { id: 'marketing', x: 66, y: 75, size: 'md' },
]

const MOBILE_NODE_LAYOUT: NodeLayout[] = [
  { id: 'events', x: 2, y: 12, size: 'md' },
  { id: 'design', x: 10, y: 21, size: 'md' },
  { id: 'hub', x: 40, y: 8, size: 'md' },
  { id: 'impact', x: 75, y: 12, size: 'md' },
  ...
  { id: 'marketing', x: 58, y: 63, size: 'md' },
]
