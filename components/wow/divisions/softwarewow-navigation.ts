        ...
        pages: [
          {
            ...
            title: 'Services',
            items: [
              { id: 'customSoftware', label: 'Custom Software', description: 'Systems built around your operations.', href: '/softwarewow#services' },
              { id: 'saasDevelopment', label: 'SaaS Development', description: 'Multi-tenant products ready to scale.', href: '/softwarewow#services' },
              { id: 'webApplications', label: 'Web Applications', description: 'Reliable apps for teams and customers.', href: '/softwarewow#services' },
              { id: 'mobileApps', label: 'Mobile Apps', description: 'iOS and Android experiences that convert.', href: '/softwarewow#services' },
              { id: 'aiAutomation', label: 'AI & Automation', description: 'Practical AI that removes busywork.', href: '/softwarewow#services' },
              { id: 'modernizationIntegrations', label: 'Modernization & Integrations', description: 'Upgrade and connect what you already have.', href: '/softwarewow#services' },
            ],
          },
        ],
      },
