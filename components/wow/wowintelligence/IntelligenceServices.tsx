...
import { INTELLIGENCE_SERVICES } from '@/data/intelligenceServices'
          ...
          <div className="flex-1 max-md:w-full">
            <TextAppearAnimation>
              <p className="text-appear max-w-lg max-md:text-justify md:place-self-end md:text-right">
                AI assistants, predictive analytics, and workflow automation — engineered inside the
                WOW Intelligence ecosystem, not bolted on.
              </p>
            </TextAppearAnimation>
