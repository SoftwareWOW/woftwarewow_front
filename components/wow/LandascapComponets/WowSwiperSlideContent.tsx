...
const WowSwiperSlideContent: FC<SwiperSlideContentProps> = ({ tags, title, userName, position, userImg }) => {
  return (
    // Remove rounded-radius-sm from here - it's handled by the parent
...
// const WowSwiperSlideContent: FC<SwiperSlideContentProps> = ({ tags, title, userName, position, userImg }) => {
//   return (
//     <div className="flex gap-3 border border-[#e5e5e5] dark:border-white/5 bg-white/80 backdrop-blur-sm rounded-radius-sm dark:bg-dark/80 p-6 md:p-10 transition-colors duration-300 shadow-sm dark:shadow-none">
//       <div className="hidden flex-grow-0 md:block">
//         <span>
//           <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
//             <path
