  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        'bg-[#615CCE] text-white shadow-lg shadow-primary/30 dark:bg-[#615CCE] dark:text-white',
    ...
    >
      <MessageCircle className="h-6 w-6 !text-white !stroke-white" stroke="currentColor" strokeWidth={1.75} />
    </motion.button>
  )
}
