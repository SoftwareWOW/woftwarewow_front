  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        'bg-primary text-white shadow-lg shadow-primary/30 dark:bg-primary dark:text-white',
    ...
    >
      <MessageCircle className="h-6 w-6 text-white dark:text-white" strokeWidth={1.75} />
    </motion.button>
  )
}
